...
const DataTableBalanceStatusFilter = ({
  column,
  title,
  options,
  className,
  ...
  const setBalanceFilter = (optionValue) => {
            ...
            <CommandGroup>
              {options.map((option) => {
                ...
                return (
                  <CommandItem
                    key={option.value}
                    onSelect={() => setBalanceFilter(option.value)} // Close popover when option is selected
                  >
                    <div
                      className={cn(
...
export default DataTableBalanceStatusFilter;
