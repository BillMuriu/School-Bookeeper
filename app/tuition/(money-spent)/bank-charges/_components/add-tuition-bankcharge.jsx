...
import { useCreateTuitionBankCharge } from "../_services/mutations"; // Changed the hook name
...
const AddBankChargeForm = () => {
  ...
  const createBankChargeMutation = useCreateTuitionBankCharge(); // Changed the hook name
