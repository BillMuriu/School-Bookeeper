...
export const columns = [
  {
    accessorKey: "receipt_number", // Add this line to reference the receipt number
    header: "Receipt Number", // Column header for Receipt Number
    cell: ({ getValue, row }) => {
      const receiptNumber = getValue(); // Get the receipt number
      const receiptId = row.original.id; // Assuming 'id' is part of the row data
      return <div className="text-center text-sm">{receiptNumber}</div>;
    },
  },
  {
