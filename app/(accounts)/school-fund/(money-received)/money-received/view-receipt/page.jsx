...
import { columns } from "../_components/school-fund-receipt-columns";
import { useSchoolFundReceipts } from "../_services/queries";
import DataTableSkeleton from "@/components/datatable-seleton-loader";

const ReceiptsTable = () => {
  const { data: receipts, isLoading, error } = useSchoolFundReceipts();
