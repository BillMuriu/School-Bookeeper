...
import {
  useEditRmiOpeningBalance,
  useDeleteRmiOpeningBalance,
...
const EditDeleteOpeningBalanceForm = ({ openingBalanceId }) => {
  ...
  const editOpeningBalanceMutation = useEditRmiOpeningBalance();
  const deleteOpeningBalanceMutation = useDeleteRmiOpeningBalance();
