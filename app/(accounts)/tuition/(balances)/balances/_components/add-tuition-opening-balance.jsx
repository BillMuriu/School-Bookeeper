...
import { useCreateTuitionOpeningBalance } from "../_services/mutations";
...
const AddTuitionOpeningBalanceForm = () => {
  const {
    formState: { errors },
    handleSubmit,
  } = useFormContext();

  const createOpeningBalanceMutation = useCreateTuitionOpeningBalance(); // Hook for creating tuition opening balance
...
export default AddTuitionOpeningBalanceForm;
