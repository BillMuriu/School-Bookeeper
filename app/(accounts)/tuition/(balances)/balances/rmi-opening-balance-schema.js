...
const tuitionOpeningBalanceSchema = z.object({
...
const defaultTuitionOpeningBalanceValues = {
  account: "tuition",
  date: new Date(),
  bankAmount: 0.0,
  cashAmount: 0.0,
...
export { tuitionOpeningBalanceSchema, defaultTuitionOpeningBalanceValues };
