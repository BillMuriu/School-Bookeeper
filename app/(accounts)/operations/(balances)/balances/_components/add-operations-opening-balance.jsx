...
import { useCreateOperationsOpeningBalance } from "../_services/mutations"; // Import the mutation hook
...
const AddOperationsOpeningBalanceForm = () => {
  const {
    formState: { errors },
    handleSubmit,
  } = useFormContext();

  const createOpeningBalanceMutation = useCreateOperationsOpeningBalance(); // Hook for creating opening balance
...
export default AddOperationsOpeningBalanceForm;
